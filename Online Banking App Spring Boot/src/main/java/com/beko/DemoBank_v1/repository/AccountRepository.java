...
public interface AccountRepository extends CrudRepository<Account, Integer> {
 ...
 // Use 'Double' with a capital D
    ...
    @Modifying
    // 1. Added 'balance' to the columns
    // 2. Added '0.00' to the VALUES
    @Query(value = "INSERT INTO accounts(user_id, account_number, account_name, account_type, balance) VALUES" +
            "(:user_id, :account_number, :account_name, :account_type, 0.00)",nativeQuery = true)
    @Transactional
